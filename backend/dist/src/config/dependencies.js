...
const authDtos_js_1 = require("../dtos/authDtos.js");
...
class AppDependencies {
    ...
    authDtoValidator = new authDtos_js_1.AuthDtoValidator();
    ...
    pdfService = new pdfService_js_1.PdfService();
    authController = new authController_js_1.AuthController(this.authService, this.authDtoValidator);
